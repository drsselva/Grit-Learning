...
public class LearnerSessionController {
	...
	//private static final Logger logger = Logger.getLogger(LearnerSessionController.class);
	...
	public ResponseEntity<?> create( @RequestHeader HttpHeaders httpHeader,
		...
		return responseGenerator.successResponse(context, messageSource.getMessage("learner.file.upload"),
				HttpStatus.OK);
		}catch(Exception e) {
			e.printStackTrace();
